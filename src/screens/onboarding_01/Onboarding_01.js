...
function Onboarding_01(props) {
  const startWithNumberButton = () => {
    ...
    props.navigation.navigate('onboarding_02');
  };
  ...
  return (
    <Onboarding
      iconColor1={CColors.white}
      iconColor2={CColors.light_green}
      iconColor3={CColors.light_green}
      title={CStrings.get_cataring_from_your_desire}
      ...
      <Image source={require('../../../assets/images/onboarding_01.png')} />
    </Onboarding>
  );
}
